...
def preprocess_wikipedia_text (text):
    # remove all the text after "References"
...
def generate_facts (df, entity_col='title', model='gpt-4o-mini', temperature=1.0, max_tokens=1024,
                    batch_size = 20, input_filepath = None, batch_log_filepath = None, cache_filepath = None, mode = 'batch_stream'):    
    
    input_prompt_template = STEP1_INPUT_PROMPT_TEMPLATE
    system_prompt = STEP1_SYSTEM_PROMPT

    template_properties = {'entity': entity_col}
